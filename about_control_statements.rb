...
class AboutControlStatements < Neo::Koan
  ...
  #If all we have is an if statement, and there's no else , it just returns nil. 
  #This is why you should ALWAYS have an else. You have to cover all of the cases.
